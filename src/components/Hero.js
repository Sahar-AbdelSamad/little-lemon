  ...
  return (
    <section className='hero'>
      <div className='hero-section'>
        {props.reservePressed ? <Bookings formData={props.formData} setBookingConfirmed={props.setBookingConfirmed} reservePressed={props.reservePressed} showBookings={props.showBookings} bookingConfirmed={props.bookingConfirmed} submitForm={props.submitForm}/> : <>
